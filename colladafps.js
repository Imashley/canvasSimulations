...
function initScene() {
	...
	var materials= [
		loadTexture('textures/cube/skybox/px.jpg'),
		loadTexture('textures/cube/skybox/nx.jpg'),
		loadTexture('textures/cube/skybox/py.jpg'),
		loadTexture('textures/cube/skybox/ny.jpg'),
		loadTexture('textures/cube/skybox/pz.jpg'),
		loadTexture('textures/cube/skybox/nz.jpg'),
		];
		
	skyBoxMesh = new THREE.Mesh( new THREE.BoxGeometry( 10000,10000,10000, 7,7,7),
	...
	myColladaLoader.load( 'cashino.dae', function ( collada ) {
